/**
 * Screen Picker - ouvre une modal pour choisir l'écran à partager
 * Utilise desktopCapturer pour lister les sources disponibles
 */
...
export async function openScreenPicker(parent: BrowserWindow): Promise<string | null> {
  // Récupérer toutes les sources (écrans + fenêtres)
  ...
  // Sérialiser les NativeImage en data URL pour le renderer
  ...
  return new Promise((resolve) => {
    ...
    // Envoyer les sources une fois la page chargée
